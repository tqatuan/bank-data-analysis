...
#set.seed(1)
#Choosing 25% of dataset to run analysis since this methods requires high computational power
#sample <- sample(c(TRUE, FALSE), nrow(bank), replace = T, prob = c(0.25,0.75))
#train <- bank[sample, ]

#Final dataset that will be used to run Gower distance
#bank_df <- train[, -c(9,10,16,17,18,19,20)]
bank_df <- bank_df[, -c(9,10,16,17,18,19,20)]
